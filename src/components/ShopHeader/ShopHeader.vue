<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="shopShow = true">
    ...
    <div class="shop-header-discounts" v-if="shopInfo.supports">
      ...
      <div class="discounts-right" @click="supportShow = true">
    ...
    <div class="shop-brief-modal" v-show="shopShow">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer">
          <span class="iconfont icon-close" @click="shopShow = false"></span>
        </div>
      </div>
    ...
    <div class="activity-sheet" v-show="supportShow">
      <div class="activity-sheet-content">
        ...
        <ul class="list">
          <li class="activity-item " :class="supportsClasses[support.type]" v-for="(support,index) in shopInfo.supports" :key="index">
            <span class="content-tag">
